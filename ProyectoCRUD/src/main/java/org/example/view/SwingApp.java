...
public class SwingApp extends JFrame {
    ...
    public SwingApp(){
        ...
        agregarButton.setBackground(new Color(46,203,113));
    ...
    private void agregarEmpleado() throws SQLException{
        //Crear un formulatio para agregar un empleado.
        ...
        if(result == JOptionPane.OK_OPTION){
            ...
            employee.setPaSurName(paternoField.getText());
            employee.setMaSurName(maternoField.getText());
        ...
        if (empleadoIdStr != null){
            try {
                ...
                if (empleado != null){
                    ...
                    JTextField apellidoPaternoField = new JTextField(empleado.getPaSurName());
                    JTextField apellidoMaternoField = new JTextField(empleado.getMaSurName());
                    ...
                    if (confirmResult == JOptionPane.OK_OPTION){
                        //Actualizar los datos del empleado con los valores engresados en el formulario
                        empleado.setFirstName(nombreField.getText());
                        empleado.setPaSurName(apellidoPaternoField.getText());
                        empleado.setMaSurName(apellidoMaternoField.getText());
    ...
    private void eliminarEmpleado(){
        ...
        if(empleadoIdStr != null){
            try {
                ...
                int confirResult = JOptionPane.showConfirmDialog(this, "Está seguro de eliminar el empleado?", "Confirmar Eliminación", JOptionPane.YES_NO_OPTION);
                if(confirResult == JOptionPane.YES_OPTION){
